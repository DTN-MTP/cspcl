...
| [Delivery Acknowledgement](https://dtn-mtp.github.io/cspcl/delivery-ack/) | How CSPCL confirms bundles actually arrive, using an application-level ack on top of unmodified libcsp |
